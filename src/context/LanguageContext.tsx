...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'features.solver_desc': 'A multi-phase C++ solver featuring lock-free bucketed Gaussian elimination in RREF, Hybrid CDCL integration, and Möller-Stetter quotient diagonalisation.',
    ...
    'hybrid.title': 'Hybrid CDCL + Lock-Free Gaussian Elimination',
    'hybrid.desc': 'Our engine combines Bounded CDCL with lock-free Gaussian elimination in reduced row echelon form (RREF) over GF(2). Under a bounded conflict budget, the CDCL engine extracts Level-0 implied units and learned XOR equivalence relations, injecting them directly into the algebraic netlist to accelerate rank growth before linear and quadratic cascade elimination.',
    ...
    // Briefing & Console Headers
    'briefing.eyebrow': 'EXECUTIVE TECHNICAL BRIEFING',
    'briefing.title': 'How the Rail is Wired: Colang to GF(2) Proofs',
    'briefing.guardrails_title': 'Proving What an AI Agent Cannot Do',
    'console.eyebrow': 'INTERACTIVE FORMAL VERIFICATION CONSOLE',
    'console.title': 'Algebraic Guardrail Verification in Action',

    // Interactive Console Demos & Tabs
    'console.demo_trade': 'Middle-Office Trade Booking Gate',
    'console.demo_or': 'Sub-Threshold Exemption OR-Accumulation',
    'console.demo_fca': 'FCA Consumer-Finance Guardrail',
    'console.tab_policy': 'Colang Policy Source',
    'console.tab_cert': 'UNSAT Certificate',
    'console.tab_patch': 'Certified Colang Patch',
    'console.cat_tool': 'Tool & MCP Dispatch',
    'console.cat_defect': 'Structural Policy Defect (SAT Bypass)',
    'console.cat_reg': 'Regulatory AI Guardrails (FCA COBS / Duty)',

    // Verdict Card & Details
    'console.verdict': 'VERDICT',
    'console.verdict_unsat': 'MATHEMATICALLY SAFE (UNSAT)',
    'console.verdict_sat': 'BYPASS VULNERABILITY FOUND (SAT)',
    'console.verdict_patch': 'ESCAPABLE GUARD DETECTED & AUTOMATICALLY REPAIRED',
    'console.steps_title': 'Steps / Derivations',
    'console.steps_val': '5 Steps (Replayable)',
    'console.proof_sys': 'Proof System',
    'console.proof_sys_val': 'GF(2) Algebra (C++)',
    'console.attack_hyp': 'Attack Hypothesis:',
    'console.attack_hyp_val': 'Action = 1 ∧ Precondition = 0',
    'console.context_space': 'Context Space:',
    'console.context_space_val': 'Quantified over all 2^N combinations',
    'console.indep_verif': 'Independent Verification:',
    'console.indep_verif_val': 'Self-contained DAG receipt',

    // Comparison Table
    'matrix.eyebrow': 'PARADIGM COMPARISON',
    'matrix.title': 'Testing Samples vs. Mathematical Decidability',
    'matrix.subtitle': 'Why conventional LLM eval suites and SMT solvers leave silent bypass vulnerabilities in production AI agents.',
    'matrix.col_metric': 'CAPABILITY / METRIC',
    'matrix.col_sampling': 'SAMPLING & LLM EVALS',
    'matrix.col_smt': 'STANDARD SMT / SAT',
    'matrix.col_quasilinear': 'QUASILINEAR GF(2)',
    'matrix.row_space': 'Context Space Guarantee',
    'matrix.row_space_sampling': '~30–100 prompt samples',
    'matrix.row_space_smt': 'Complete (Slow)',
    'matrix.row_space_quasi': 'All 2^N combinations (Quantified)',
    'matrix.row_impossibility': 'Proof of Impossibility',
    'matrix.row_impossibility_sampling': 'None (Pass = No failure observed)',
    'matrix.row_impossibility_smt': 'DRAT / LRAT (Verbose)',
    'matrix.row_impossibility_quasi': 'Replayable DAG of row XORs (UNSAT)',
    'matrix.row_replay': 'Audit Replayability',
    'matrix.row_replay_sampling': 'Non-deterministic',
    'matrix.row_replay_smt': 'Requires solver binary',
    'matrix.row_replay_quasi': 'Independent 1-page verifier script',
    'matrix.row_repair': 'Policy Repair & Patching',
    'matrix.row_repair_sampling': 'Manual prompt tweaking',
    'matrix.row_repair_smt': 'Unsatisfiable Core only',
    'matrix.row_repair_quasi': 'Automated Colang patch with SDS score',
    'matrix.row_counting': 'Counting Completeness',
    'matrix.row_counting_sampling': 'Impossible',
    'matrix.row_counting_smt': 'Blocking clause loops',
    'matrix.row_counting_quasi': 'Möller–Stetter quotient diagonalisation',
    ...
    'footer.address': 'Jubilee House, The Drive, Brentwood, United Kingdom, CM13 3FR',
  ...
  pt: {
    ...
    'features.solver_desc': 'Um solver C++ multifase com eliminação gaussiana em RREF lock-free em baldes, integração Híbrida CDCL e diagonalização de quociente de Möller-Stetter.',
    ...
    // Briefing & Console Headers
    'briefing.eyebrow': 'BRIEFING TÉCNICO EXECUTIVO',
    'briefing.title': 'Como o Rail é Conectado: Colang para Provas GF(2)',
    'briefing.guardrails_title': 'Provando o que um Agente de IA Não Pode Fazer',
    'console.eyebrow': 'CONSOLE INTERATIVO DE VERIFICAÇÃO FORMAL',
    'console.title': 'Verificação Algébrica de Guardrails em Ação',

    // Interactive Console Demos & Tabs
    'console.demo_trade': 'Portão de Agendamento de Operações de Middle-Office',
    'console.demo_or': 'Acumulação OU de Isenção Sub-Limiar',
    'console.demo_fca': 'Guardrail de Finanças do Consumidor FCA',
    'console.tab_policy': 'Fonte da Política Colang',
    'console.tab_cert': 'Certificado UNSAT',
    'console.tab_patch': 'Patch Colang Certificado',
    'console.cat_tool': 'Despacho de Ferramenta e MCP',
    'console.cat_defect': 'Defeito Estrutural de Política (Bypass SAT)',
    'console.cat_reg': 'Guardrails de IA Regulatória (FCA COBS / Duty)',

    // Verdict Card & Details
    'console.verdict': 'VEREDITO',
    'console.verdict_unsat': 'MATEMATICAMENTE SEGURO (UNSAT)',
    'console.verdict_sat': 'VULNERABILIDADE DE BYPASS ENCONTRADA (SAT)',
    'console.verdict_patch': 'GUARDRAIL ESCAPÁVEL DETECTADO E REPARADO AUTOMATICAMENTE',
    'console.steps_title': 'Etapas / Derivações',
    'console.steps_val': '5 Etapas (Reproduzíveis)',
    'console.proof_sys': 'Sistema de Prova',
    'console.proof_sys_val': 'Álgebra GF(2) (C++)',
    'console.attack_hyp': 'Hipótese de Ataque:',
    'console.attack_hyp_val': 'Ação = 1 ∧ Pré-condição = 0',
    'console.context_space': 'Espaço de Contexto:',
    'console.context_space_val': 'Quantificado em todas as 2^N combinações',
    'console.indep_verif': 'Verificação Independente:',
    'console.indep_verif_val': 'Comprovante DAG autônomo',

    // Comparison Table
    'matrix.eyebrow': 'COMPARAÇÃO DE PARADIGMAS',
    'matrix.title': 'Amostragem de Testes vs. Decidibilidade Matemática',
    'matrix.subtitle': 'Por que suítes de avaliação de LLM convencionais e solvers SMT deixam vulnerabilidades de bypass silenciosas em agentes de IA em produção.',
    'matrix.col_metric': 'CAPACIDADE / MÉTRICA',
    'matrix.col_sampling': 'AMOSTRAGEM E AVALIAÇÕES DE LLM',
    'matrix.col_smt': 'SMT / SAT PADRÃO',
    'matrix.col_quasilinear': 'GF(2) QUASE-LINEAR',
    'matrix.row_space': 'Garantia do Espaço de Contexto',
    'matrix.row_space_sampling': 'Amostras de ~30–100 prompts',
    'matrix.row_space_smt': 'Completo (Lento)',
    'matrix.row_space_quasi': 'Todas as 2^N combinações (Quantificadas)',
    'matrix.row_impossibility': 'Prova de Impossibilidade',
    'matrix.row_impossibility_sampling': 'Nenhuma (Aprovado = Sem falhas observadas)',
    'matrix.row_impossibility_smt': 'DRAT / LRAT (Detalhado)',
    'matrix.row_impossibility_quasi': 'DAG reproduzível de XORs de linha (UNSAT)',
    'matrix.row_replay': 'Reprodutibilidade de Auditoria',
    'matrix.row_replay_sampling': 'Não-determinístico',
    'matrix.row_replay_smt': 'Requer binário do solver',
    'matrix.row_replay_quasi': 'Script verificador independente de 1 página',
    'matrix.row_repair': 'Reparo e Correção de Políticas',
    'matrix.row_repair_sampling': 'Ajuste manual de prompts',
    'matrix.row_repair_smt': 'Apenas Núcleo Insatisfatível',
    'matrix.row_repair_quasi': 'Patch Colang automatizado com pontuação SDS',
    'matrix.row_counting': 'Completude de Contagem',
    'matrix.row_counting_sampling': 'Impossível',
    'matrix.row_counting_smt': 'Loops de cláusulas de bloqueio',
    'matrix.row_counting_quasi': 'Diagonalização de quociente de Möller–Stetter',
