    ...
    <main>
      ...
      <section id="gallery" className="py-24 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div>
              <h2 className="text-3xl md:text-5xl font-display font-bold mb-4">TACTICAL <span className="text-brand-muted">VALIDATION</span></h2>
              <p className="text-white/40 max-w-md">Rigorous C++ simulation framework modelling real-world RF physics and hardware drift.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="aspect-video rounded-2xl overflow-hidden relative group border border-white/5">
              ...
              <div className="absolute inset-0 bg-black/60 opacity-100 transition-opacity flex flex-col items-center justify-center p-6 text-center">
                ...
                <span className="text-sm font-display font-bold">Terrain Masking Re-acquisition</span>
              </div>
            </div>
            <div className="aspect-video rounded-2xl overflow-hidden relative group border border-white/5">
              ...
              <div className="absolute inset-0 bg-black/60 opacity-100 transition-opacity flex flex-col items-center justify-center p-6 text-center">
                ...
                <span className="text-sm font-display font-bold">High-Speed Signal Tracking</span>
              </div>
            </div>
            <div className="aspect-video rounded-2xl overflow-hidden relative group border border-white/5">
              ...
              <div className="absolute inset-0 bg-black/60 opacity-100 transition-opacity flex flex-col items-center justify-center p-6 text-center">
                ...
                <span className="text-sm font-display font-bold">Non-Kinetic Disarm Injection</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white text-black overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl font-display font-bold mb-8 tracking-tighter">SECURE YOUR <br /> AIRSPACE</h2>
          <p className="text-black/60 max-w-xl mx-auto mb-10 font-medium">
            Join the next generation of software-defined defence. Request a full technical briefing and TRL4 validation report.
          </p>
          <Link to="/contact">
